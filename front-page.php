...
<div class="askee-homepage">
    <div class="container-fluid container-fluid--padding" data-askee-page="home">
        <div class="askee-homepage__wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8 offset-lg-2">
                            <div class="askee-homepage__content">
                                <div class="askee-homepage__image askee-homepage__image--first">
                                    <dotlottie-player
                                        src="<?php echo get_template_directory_uri(); ?>/images/stars.lottie"
                                        background="transparent"
                                        speed="1"
                                        style="display: block; width: 100%; max-width: 550px; height: auto"
                                        loop
            ...
            <div class="askee-homepage__item">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 offset-lg-2">
                        <div class="askee-homepage__content">
                            <div class="askee-homepage__image askee-homepage__image--second">
                                <dotlottie-player
                                        src="<?php echo get_template_directory_uri(); ?>/images/stars.lottie"
                                        background="transparent"
                                        speed="1"
        ...
        <div class="askee-homepage__item">
            ...
            <div class="row">
                <div class="col-12 col-lg-8 offset-lg-2">
                    <div class="askee-homepage__content">
                        <div class="askee-homepage__image askee-homepage__image--third">
                            <dotlottie-player
                                        src="<?php echo get_template_directory_uri(); ?>/images/stars.lottie"
                                        background="transparent"
                                        speed="1"
    ...
    <div class="askee-homepage__item">
        ...
        <div class="row">
            <div class="col-12 col-lg-8 offset-lg-2">
                <div class="askee-homepage__content">
                    <div class="askee-homepage__image askee-homepage__image--fourth">
                        <dotlottie-player
                                        src="<?php echo get_template_directory_uri(); ?>/images/stars.lottie"
                                        background="transparent"
                                        speed="1"
